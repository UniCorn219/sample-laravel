...
return [
    ...
    */
    ...
    'nickname_invalid'      => '닉네임에 잘못된 문자가 포함되어 있습니다.',
    'nickname_updated_rule' => '닉네임은 한 달에 한 번만 업데이트할 수 있습니다.',
    ...
    'max' => [
        ...
        'file_upload' => '파일용량이 최적화해도 5mb 넘었습니다. 다른 파일로 선택해주세요',
        'file_mime' => 'アップロードファイルのタイプが無効です',
    ...
    'unique' => ':attribute 중복된 닉네임입니다',
    'uploaded' => 'The :attribute failed to upload.',
    'url' => ':attribute 값이 유효한 URL이 아닙니다.',
    'uuid' => 'The :attribute must be a valid UUID.',
    'promotion_exists_in_localinfo' => '현재 이 근처소식의 광고 이벤트가 있습니다.이 근처소식의 다른 광고 이벤트를 만들 수 없습니다.',
