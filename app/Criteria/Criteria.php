...
abstract class Criteria
{
     ...
     */
    public function apply(\Illuminate\Database\Eloquent\Builder|Builder $query)
    {
        $this->setTable($query);
     ...
     * @param $value
     */
    protected function basicCriteria(\Illuminate\Database\Eloquent\Builder|Builder $query, $key, $value)
    {
        $criteria = $this->getCriteria();
