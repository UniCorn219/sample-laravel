...
class PushNotificationJobNonQueue extends Job
{
    private string $tokenFcm;
    private string $content;
    private string $title;
    private array  $options;
    protected bool $isPushImage;
     ...
     * @param string $title
     * @param array  $options
     * @param bool   $isPushImage
     */
    public function __construct(string $tokenFcm, string $content, string $title, array $options = [], bool $isPushImage = false)
    {
