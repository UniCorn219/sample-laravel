...
class CreateShippingCompanyMessageOperation extends Operation
{
     ...
     * @return void
     */
    public function __construct(User|Store $sender, string $threadFuid, string $text, string $id, $shippingCompany)
    {
        $this->sender          = $sender;
    ...
    public function handle()
    {
        $attributes = [
            'uuid'             => $this->id,
            'type'             => MessageType::SHIPPING_COMPANY,
            'text'             => $this->text,
            'attachment'       => null,
            'sender'           => [
